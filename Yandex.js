...
» Information:
☇ Inventor : Я - Zeroth
☇ Name Script : Symphony's - Everyday 𖣂 
☇ Version : 1.0
`));
}
startTelegramBot()
...
async function connectToWhatsApp(botNumber, chatId) {
  let statusMessage = await bot
    .sendMessage(
      chatId,
      `
<blockquote>#Symphony's ⵢ Everyday ⚘</blockquote>
...
<blockquote>め /Update - Update new script</blockquote>
...
`,
      ...
      reply_markup: {
        ...
        /// --- ( Forlet ) --- \\\
         ...
         console.log(chalk.red(`𖣂 Symphony's  ⵢ Everyday 𖣂`));
...
bot.onText(/^\/Update$/, async (msg) => {
    ...
    try {
        ...
        console.error(err);
        bot.sendMessage(chatId, "❌ Gagal update! Periksa GitHub atau file yang kamu upload.");
    }
});
